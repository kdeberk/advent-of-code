...
impl Game {
    pub fn read_file(filename: &str, elves_attack_power: u32) -> Self {
...
fn part_1(filename: &str) -> u32 {
    let mut game = Game::read_file(filename, 3);
...
fn part_2(filename: &str) -> Option<u32> {
    for attack_power in 4.. {
        let mut game = Game::read_file(filename, attack_power);
